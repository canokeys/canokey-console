...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m10(layout) => "当前：${layout}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "settingsKeyboardLayoutCustom":
            MessageLookupByLibrary.simpleMessage("自定义布局"),
        "settingsKeyboardLayoutDefault":
            MessageLookupByLibrary.simpleMessage("默认 / US QWERTY"),
        "settingsKeyboardLayoutUnknown":
            MessageLookupByLibrary.simpleMessage("未知"),
        "settingsKeyboardLayoutUnknownPrompt":
            MessageLookupByLibrary.simpleMessage(
