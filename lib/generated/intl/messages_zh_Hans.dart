...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m19(slot) => "已为 ${slot} 槽位应用推荐设置";

  static String m20(sourceSlot) => "移动 ${sourceSlot} 中的密钥";

  static String m21(count) => "${count} 个已占用";
  ...
  static String m24(index) => "历史密钥 ${index}";

  static String m25(remaining, total) => "剩余次数：${remaining}/${total}";

  static String m26(policy) => "触摸：${policy}";

  static String m27(layout) => "当前：${layout}";

  static String m28(applet) => "重置后，${applet} 中的所有数据都将被删除，无法恢复。";

  static String m29(min) => "至少 ${min} 个字符";

  static String m30(max) => "最多 ${max} 个字符";

  static String m31(length) => "需要 ${length} 个字符";

  static String m32(max) => "请输入不大于 ${max} 的整数。";

  static String m33(min) => "请输入不小于 ${min} 的整数。";

  static String m34(name) => "删除 ${name} 的登录凭据？此操作无法撤销，请先确认您有其他方式登录该服务。";

  static String m35(min) => "最小 PIN 长度只能调大、不能调小，且不得小于 ${min}。";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "ndefInvalidMessage": MessageLookupByLibrary.simpleMessage(
      "无法读取已有的 NFC 标签内容。如需重新设置，请在设置中重置 NFC Tag；这会删除原有的标签内容。",
    ),
    ...
    "ndefReadOnly": MessageLookupByLibrary.simpleMessage("NFC 标签当前为只读。"),
    ...
    "ndefSaved": MessageLookupByLibrary.simpleMessage("NFC 标签记录已保存"),
    ...
    "passSlotConfigPrompt": MessageLookupByLibrary.simpleMessage(
      "选择触摸 CanoKey 时执行的操作。如需输出 HOTP 验证码，请在 OTP 页面设置。",
    ),
    ...
    "pivPrintedDataWarning": MessageLookupByLibrary.simpleMessage(
      "警告：启用 PIN-only 模式后，切勿覆盖 PRINTED（Printed Information）数据对象。该对象保存着受 PIN 保护的管理密钥，覆盖它将导致密钥丢失，失去对 PIV 应用的管理权限。",
    ),
    ...
    "settingsInputPin": MessageLookupByLibrary.simpleMessage("管理 PIN 验证"),
    "settingsInputPinPrompt": MessageLookupByLibrary.simpleMessage(
      "请输入管理 PIN，默认值为 123456。它与 WebAuthn、OpenPGP、PIV 等应用的 PIN 分别设置。",
    ),
    ...
    "settingsNDEF": MessageLookupByLibrary.simpleMessage("NFC 标签模式"),
    ...
    "webauthnAlwaysUv": MessageLookupByLibrary.simpleMessage("始终要求用户验证"),
    "webauthnAlwaysUvDescription": MessageLookupByLibrary.simpleMessage(
      "启用后，每次 WebAuthn 登录都需要验证 PIN。启用后还会禁用 CanoKey 的传统 U2F 接口。",
    ),
    ...
    "webauthnDangerZone": MessageLookupByLibrary.simpleMessage("危险操作"),
    "webauthnDelete": m34,
    ...
    "webauthnLongTouchWarning": MessageLookupByLibrary.simpleMessage(
      "启用后，重置 WebAuthn 需要长按触摸 CanoKey 30 秒。此设置无法撤销，只有重置 WebAuthn 才能清除。",
    ),
    "webauthnMinPinLength": MessageLookupByLibrary.simpleMessage("最小 PIN 长度"),
    ...
    "webauthnPinPolicyViolation": MessageLookupByLibrary.simpleMessage(
      "CanoKey 拒绝了此更改：最小 PIN 长度只能调大、不能调小。",
    ),
