...
class ManagementKeyDialog extends StatelessWidget with UIMixin {
  ...
  static Future<void> show(
    Future<void> Function(String oldKey, String newKey) onSubmit,
  ) {
    return AppDialog.show(ManagementKeyDialog(onSubmit: onSubmit));
  }
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Spacing.width(8),
                        CustomizedButton(
                          onPressed: () => validator.getController('old')!.text =
                      ...
                      children: [
                        ...
                        CustomizedButton(
                          onPressed: () {
                            ...
                            validator.getController('new')!.text = hex.encode(
                              values,
                            );
                          },
                          elevation: 0,
