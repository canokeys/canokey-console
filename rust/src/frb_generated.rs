...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 684020921;
...
fn wire__crate__api__crypto__hmac_sha1_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            transform_result_sse::<_, ()>((move || {
                let output_ok =
                    Result::<_, ()>::Ok(crate::api::crypto::hmac_sha1(api_key, api_data))?;
                Ok(output_ok)
            })())
        },
    )
...
fn wire__crate__api__crypto__pbkdf2_hmac_sha1_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            deserializer.end();
            transform_result_sse::<_, ()>((move || {
                let output_ok = Result::<_, ()>::Ok(crate::api::crypto::pbkdf2_hmac_sha1(
                    api_password,
                    api_salt,
                    api_iterations,
                    api_key_len,
...
fn wire__crate__api__crypto__sha256_digest_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            deserializer.end();
            transform_result_sse::<_, ()>((move || {
                let output_ok = Result::<_, ()>::Ok(crate::api::crypto::sha256_digest(api_data))?;
                Ok(output_ok)
            })())
        },
    )
...
fn wire__crate__api__crypto__sha384_digest_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            deserializer.end();
            transform_result_sse::<_, ()>((move || {
                let output_ok = Result::<_, ()>::Ok(crate::api::crypto::sha384_digest(api_data))?;
                Ok(output_ok)
            })())
        },
    )
...
fn wire__crate__api__crypto__sha512_digest_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            deserializer.end();
            transform_result_sse::<_, ()>((move || {
                let output_ok = Result::<_, ()>::Ok(crate::api::crypto::sha512_digest(api_data))?;
                Ok(output_ok)
            })())
        },
    )
...
fn wire__crate__api__crypto__verify_piv_signature_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            deserializer.end();
            transform_result_sse::<_, ()>((move || {
                let output_ok = Result::<_, ()>::Ok(crate::api::crypto::verify_piv_signature(
                    api_algorithm,
                    api_public_key,
                    api_data,
                    api_signature,
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        2 => wire__crate__api__crypto__encrypt_piv_management_key_challenge_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        3 => wire__crate__api__crypto__hmac_sha1_impl(ptr, rust_vec_len, data_len),
        4 => wire__crate__api__init_app_impl(ptr, rust_vec_len, data_len),
        5 => wire__crate__api__crypto__parse_x509_cert_from_der_impl(ptr, rust_vec_len, data_len),
        6 => wire__crate__api__crypto__parse_x509_cert_from_pem_impl(ptr, rust_vec_len, data_len),
        7 => wire__crate__api__crypto__pbkdf2_hmac_sha1_impl(ptr, rust_vec_len, data_len),
        8 => wire__crate__api__crypto__sha256_digest_impl(ptr, rust_vec_len, data_len),
        9 => wire__crate__api__crypto__sha384_digest_impl(ptr, rust_vec_len, data_len),
        10 => wire__crate__api__crypto__sha512_digest_impl(ptr, rust_vec_len, data_len),
        11 => wire__crate__api__crypto__sm2_message_digest_impl(ptr, rust_vec_len, data_len),
        12 => wire__crate__api__crypto__tdes_ede3_enc_impl(ptr, rust_vec_len, data_len),
        13 => wire__crate__api__crypto__verify_piv_signature_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
